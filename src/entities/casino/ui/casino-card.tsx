...
const CasinoCard: React.FC<CasinoCardProps> = async ({ uuid, name, bonusTitle, logoUrl, features, rating, casinoType }) => {
	...
	return (
		<Card className="w-full p-5 lg:p-4 space-y-5 border min-w-[250px] md:max-w-[305px] mx-auto md:min-w-[305px] lg:min-w-[unset] lg:max-w-[unset]">
			...
			<CardFooter className="flex flex-col space-y-2 p-[unset]">
