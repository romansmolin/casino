'use client'
import { Pagination, PaginationContent, PaginationPrevious, PaginationItem, PaginationEllipsis, PaginationLink, PaginationNext } from '@/shared/ui/pagination'
...
const PaginationControl: React.FC<PaginationControlProps> = ({ currentPage, totalPages }) => {
    ...
    return (
        <Pagination className='text-primary-600'>
            <PaginationContent>
                <PaginationPrevious onClick={currentPage > 1 ? () => getToPage(previousPage) : () => { }} />
                {showLeftEllipsis && (
                    <PaginationItem>
                        <PaginationEllipsis />
                    </PaginationItem>
                ...
                <PaginationItem>
                    <PaginationNext onClick={currentPage < totalPages ? () => getToPage(nextPage) : () => { }}
                    />
                </PaginationItem>
            </PaginationContent>
        </Pagination>
