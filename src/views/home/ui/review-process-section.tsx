        ...
        <>
            ...
            <div className="relative bento-block animate-bento-block grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-[unset] lg:grid-cols-5">
                ...
                <div className="lg:col-span-3">
                    ...
                    <div className="grid gap-12 ">
                        ...
                        <div className="space-y-6 lg:space-y-10">
                            ...
                            {/* Icon Block */}
                            <div className="flex">
                                <Binoculars className="shrink-0 mt-2 h-6 w-6" />
                                <div className="ms-5 sm:ms-8">
                                    <h3 className="text-base sm:text-lg font-semibold">
                            ...
                            {/* Icon Block */}
                            <div className="flex">
                                <SquarePen className="shrink-0 mt-2 h-6 w-6" />
                                <div className="ms-5 sm:ms-8">
                                    <h3 className="text-base sm:text-lg font-semibold">
                ...
                <div className="flex justify-center items-center flex-1 lg:col-span-2">
                    {/* <Image src={'/assets/review_process.png'} alt="Review Procees" width={300} height={300} /> */}
                </div>
            </div>
            {/* End Icon Blocks */}
        </>
